...
window.vc || (window.vc = {}),
    ...
    function($) {
        ...
        window.vc.EditElementPanelView = vc.PanelView.vcExtendUI(vc.HelperAjax).vcExtendUI(vc.ExtendPresets).vcExtendUI(vc.ExtendTemplates).vcExtendUI(vc.HelperPrompts).extend({
            ...
            buildParamsContent: function(data) {
              /* nectar addition */
              /* $panelHeader function input param becomes data */
    ...
    function($) {
        ...
        vc.map = {}, vc.setFrameSize = function(size) {
            ...
            clone: function(new_model) {
                var builder = new vc.ShortcodesBuilder;
                if (new_model && new_model.preventDefault && new_model.preventDefault(), new_model && new_model.stopPropagation && new_model.stopPropagation(), this.builder && !this.builder.is_build_complete) return !1;
    ...
    function($) {
        ...
        window.vc.cloneMethod_vc_tab = function(data, model) {
            ...
            removeTab: function(index) {
                ...
                var $tab = this.tabsControls().find("[data-m-id=" + index.get("id") + "]"),
                    index = $tab.index();
